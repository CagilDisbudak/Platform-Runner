...
public class PathFollowing : MonoBehaviour
{
    ...
    private float speed = 6f; //As I mention in ReadMe File, normally speed should be 2.55f , but in unity engine it will be bugged.The AIs not going forward, they are going back.
    private int current;
    private float min;
    private float min1;
    private int last;
